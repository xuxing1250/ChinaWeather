...
public class CityName {
    public static final String QUERYSTRING = "http://wthrcdn.etouch.cn/WeatherApi?city=";
    public static final String QUERYSTRING_INPUT = "http://www.google.com/ig/api?hl=zh_cn&weather=";
